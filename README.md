...
```console
git clone https://github.com/BahrouniAyoub/resume-builder.git
cd resume-builder
```
...
| GET    | `/resumes`  | Get user's resumes | Required       |

### Resume Routes (`/api/resumes`)

| Method | Endpoint            | Description         | Authentication |
| ------ | ------------------- | ------------------- | -------------- |
| POST   | `/create`           | Create new resume   | Required       |
| PUT    | `/update`           | Update resume       | Required       |
| DELETE | `/delete/:resumeId` | Delete resume       | Required       |
| GET    | `/get/:resumeId`    | Get specific resume | Required       |
| GET    | `/public/:resumeId` | Get public resume   | None           |

### AI Routes (`/api/ai`)

| Method | Endpoint             | Description                  | Authentication |
| ------ | -------------------- | ---------------------------- | -------------- |
| POST   | `/enhanced-pro-sum`  | Enhance professional summary | Required       |
| POST   | `/enhanced-job-desc` | Enhance job description      | Required       |
| POST   | `/upload-resume`     | Generate resume from PDF text | Required       |
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2FBahrouniAyoub%2Fresume-builder%2Ftree%2Fmain%2Fclient)
...
This project is licensed under the **MIT License** - see the [LICENSE](https://github.com/BahrouniAyoub/resume-builder/blob/main/LICENSE) file for details.

---

## Support

For support, contact **BahrouniAyoub** or create an issue in the GitHub repository.
...
- **BahrouniAyoub** | [Github](https://github.com/BahrouniAyoub)

[![GitHub](https://img.shields.io/badge/GitHub-100000?style=for-the-badge&logo=github&logoColor=white)](https://github.com/BahrouniAyoub)
